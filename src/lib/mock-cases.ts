    ...
    suspects: [
      {
        ...
        age: 38,
        occupation: "부팀장",
        relation: "피해자와 승진 경쟁 관계. 최근 인사평가에서 밀린 것으로 알려짐.",
      ...
      },
      {
        ...
        age: 31,
        occupation: "기획자",
        relation: "사건 당일 피해자와 회의실에서 크게 다툼. 목격자가 다수.",
      ...
      },
      {
        ...
        age: 29,
        occupation: "개발자",
        relation: "피해자에게 최근 업무상 강하게 질책을 받음.",
      ...
      },
      {
        ...
        age: 35,
        occupation: "인사팀장",
        relation: "피해자의 인사평가 자료를 보관 중. 열람 기록이 남아 있음.",
        alibi: "인사팀 사무실에서 서류를 정리하고 있었다고 진술",
      },
    ],
    evidence: [
      { id: "e1", name: "깨진 머그컵", description: "피해자 책상 옆 바닥에서 산산조각 난 채 발견. 커피 자국이 벽까지 튀어 있다.", location: "피해자 책상 옆" },
      { id: "e2", name: "꺼진 CCTV 기록", description: "사건 직전 30분간 12층 전체 CCTV가 원인 모를 정전으로 꺼져 있었다.", location: "관제실 서버" },
      { id: "e3", name: "피해자의 노트북", description: "화면은 열린 채였고, 사건 직전 누군가와 나눈 메시지 일부가 삭제된 흔적이 있다.", location: "피해자 책상" },
      { id: "e4", name: "잠긴 사무실 문", description: "사무실 문은 안쪽에서 잠겨 있었다. 예비 열쇠 소지자는 제한적이다.", location: "사무실 출입문" },
      { id: "e5", name: "책상 아래 혈흔", description: "책상 아래에서 소량의 혈흔 발견. 피해자의 것과 일치하지 않을 가능성이 있다.", location: "책상 아래" },
      { id: "e6", name: "정전 기록", description: "12층 배전반에 수동 조작 흔적. 정전은 자연적으로 발생한 것이 아니다.", location: "12층 배전반" },
    ],
  },
  {
